...
/**
 * Interface for any Decimal.utils-like library
 * Allows us to accept Decimal.utils from different
...
declare interface EngineConfig {
	 ...
	 * generated specifically for each type of client, eg. Node.utils client and Edge
...
declare type InternalRequestParams = {
	...
	clientMethod: string;
	/**
	 * Name of utils model that triggered the request. Might be used
 ...
 * This is because we cannot bundle `node-fetch` as it uses many other Node.utils

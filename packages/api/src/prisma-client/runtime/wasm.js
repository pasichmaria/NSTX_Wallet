...
M.toFraction = function (e) {
  ...
  return (
    ...
    (u.s = l.s = _.s),
    (h =
      Z(l, n, i, 1).minus(_).abs().cmp(Z(u, r, i, 1).minus(_).abs()) < 1
        ? [l, n]
        : [u, r]),
    (T.precision = c),
    (q = !0),
...
d();
m();
var jd = "Interactive transactions error",
  zr = class extends ee {
    constructor(r, n = jd) {
      super(n, z(r, !1));
...
function vy(e) {
  if (e) {
    ...
    Ft(e, "Unknown transactions kind");
  }
}
function Sl(e) {
...
var My = {
  ...
  Sy = Symbol.for("prisma.client.transactions.id"),
  Oy = {
    id: 0,
    nextId() {
      return ++this.id;
...
//# sourceMappingURL=wasm.utils.map
